  ...
  <v-container class="background1">
    ...
    <div class="rec2">
      <form class="block1" v-on:submit.prevent="submitform">
        ...
        />
        <!-- notification -->
        <button class="eye-icon" v-on:click.prevent="toggleConfirmPasswordVisibility">
          <img src="../assets/view.png" width="25" height="25" />
        </button>
          ...
          axios
              ...
              .then(response => {
                  if (response.data.message === 'success') {
                      this.toastStore.showToast(10000, 'The user is registered. Please login.', 'bg-emerald-500')
